...
def snap(regime=True):
    def d(sym):
        x={"ok":True,"candidate_direction":"LONG","canonical_decision":{"source_of_truth":"FINAL_TRADE_GATE","trade_ready":False,"decision_id":sym,"raw_wait_reason":"HTF_CONFLICT"},
           ...
           "geometry_gate":{"qualified":True},"trade_plan":{"rr_tp2":2.2},"futures_available":True,"futures_direction":"LONG","futures_provider":"TEST"}
        if regime:x["independent_market_regime"]={"regime":"TREND_UP"}
        return x
