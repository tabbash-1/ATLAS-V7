...
def analyze_frames(frames,proposed_direction=None):
    ...
    context_risk=_context_risk(states,direction,px)
    if status=="PASS" and context_risk:
        status,reason="WAIT",context_risk
