...
def install(atlas):
    ...
    def build_decision(symbol):
        ...
        # Independent shadow regime is computed from the same point-in-time candles
        # before the candidate/scorer result. It never changes Production.
        independent_regime = independent_regime_analyze(symbol, ks, btc)
